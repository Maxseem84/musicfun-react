import type { GetTrackDetailsOutput, GetTrackListOutput } from './api';

export const getTrack = (trackId: string) => {
  const promise: Promise<GetTrackDetailsOutput> = Promise.resolve({
    data: {
      id: 'cd03ece3-550e-4648-a7cb-a46d75324038',
      type: 'tracks',
      attributes: {
        title: 'ort',
        lyrics: '',
        ...
        releaseDate: '2025-12-22T16:35:05.775Z',
        addedAt: '2025-11-19T18:00:27.476Z',
        updatedAt: '2025-12-26T11:38:31.387Z',
        duration: 0,
        attachments: [
          {
            id: '980cdf8c-ee8d-4039-8cc4-7f730f84dbc5',
            addedAt: '2025-11-19T18:00:01.833Z',
            updatedAt: '2025-11-19T18:00:01.833Z',
            version: 1,
            url: 'https://production-it-incubator.s3.eu-central-1.amazonaws.com/apihub-spotifun/Video/09a345c9-66d3-4e6f-8c6c-3c3b8ee3e342_9a6106c12d4482.mp3',
            contentType: 'audio/mpeg',
            originalName: '9a6106c12d4482.mp3',
            fileSize: 977642,
          },
        ],
        images: {
        ...
        publishedAt: '2025-12-22T16:35:35.483Z',
        isPublished: true,
      },
    },
  });
...
export const getTracks = () => {
  const promise: Promise<GetTrackListOutput> = Promise.resolve({
    data: [
      ...
      {
        id: 'e3373a4d-8e10-483d-883a-839c29edc12b',
        type: 'tracks',
        attributes: {
          title: 'jj',
          user: {
          ...
          addedAt: '2025-11-19T18:00:27.576Z',
          attachments: [
            {
              id: '44f85b1b-bd4c-454d-85f4-0cdaffd746ce',
              addedAt: '2025-11-19T18:00:08.201Z',
              updatedAt: '2025-11-19T18:00:08.201Z',
              version: 1,
              url: 'https://production-it-incubator.s3.eu-central-1.amazonaws.com/apihub-spotifun/Video/1ec37612-0fb3-498a-ba0c-e4f17b5e7807_9a6106c12d4482.mp3',
              contentType: 'audio/mpeg',
              originalName: '9a6106c12d4482.mp3',
              fileSize: 977642,
            },
          ...
          currentUserReaction: 0,
          publishedAt: '2025-12-22T15:36:55.083Z',
          likesCount: 2,
          isPublished: true,
        },
        relationships: {
      ...
      {
        id: 'dba692f8-398b-4204-924b-e0a27aed753a',
        type: 'tracks',
        attributes: {
          title: 'CAT CAT CAT ',
          user: {
          ...
          addedAt: '2025-12-17T14:41:36.198Z',
          attachments: [
            {
              id: 'e195106a-f0e6-4cf8-b245-b511886dcc88',
              addedAt: '2025-12-17T14:41:30.237Z',
              updatedAt: '2025-12-17T14:41:30.237Z',
              version: 1,
              url: 'https://production-it-incubator.s3.eu-central-1.amazonaws.com/apihub-spotifun/Video/81e04ad6-7203-4128-8b82-bf4e1ae6557c_sample-9s.mp3',
              contentType: 'audio/mpeg',
            ...
            main: [
              {
                ...
                height: 156,
                fileSize: 6154,
                url: 'https://production-it-incubator.s3.eu-central-1.amazonaws.com/apihub-spotifun/Image/d342d9c6-99f1-447c-b679-a25bb4fdabe7_image.png',
              },
              {
                type: 'thumbnail',
                width: 48,
                height: 48,
                fileSize: 910,
                url: 'https://production-it-incubator.s3.eu-central-1.amazonaws.com/apihub-spotifun/Image/73ef09db-18c5-43e3-9fd5-02ce0b508f65_image.png',
              },
              {
                type: 'original',
                width: 202,
                height: 202,
                fileSize: 14426,
                url: 'https://production-it-incubator.s3.eu-central-1.amazonaws.com/apihub-spotifun/Image/33704192-e77d-433c-8e4a-aaa69d453242_images.jpg',
              },
            ],
          },
          currentUserReaction: 0,
          publishedAt: '2025-12-17T14:42:28.690Z',
          likesCount: 2,
          isPublished: true,
        },
        relationships: {
